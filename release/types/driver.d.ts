...
export declare class Driver extends Class.Null implements Mapping.Driver {
     ...
     */
    insert<T extends Mapping.Types.Entity>(model: Mapping.Types.Model<T>, view: string, entities: T[]): Promise<string[]>;
    /**
     ...
     */
    updateById(model: Mapping.Types.Model, view: string, id: any, entity: Mapping.Types.Model): Promise<boolean>;
    /**
