...
export declare class Schema extends Aliases.Schema {
     ...
     */
    static ObjectId(): Aliases.PropertyDecorator;
    /**
     * Decorates the specified property to be the document object Id column.
     * @returns Returns the decorator method.
     */
    static DocumentId(): Aliases.PropertyDecorator;
    /**
     ...
     * @returns Returns the decorator method.
     */
    static ArrayIds(unique?: boolean, minimum?: number, maximum?: number): Aliases.PropertyDecorator;
    /**
     * Decorates the specified property to be an Object Id column.
     * @returns Returns the decorator method.
     */
    static Binary(): Aliases.PropertyDecorator;
}
